...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.DegradeNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.DegradeNacosPublisher;
...
public class DegradeController {
    ...
    @Autowired
    private DegradeNacosPublisher degradeNacosPublisher;
    @Autowired
    private DegradeNacosProvider degradeNacosProvider;
...
//            List<DegradeRuleEntity> rules = sentinelApiClient.fetchDegradeRuleOfMachine(app, ip, port);
            List<DegradeRuleEntity> rules = degradeNacosProvider.getRules(app);
    ...
    private void publishRules(String app) throws Exception{
        ...
        degradeNacosPublisher.publish(app,rules);
    }
